  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-100 px-6 py-10">
      <div className="w-full max-w-sm">
        <h1 className="mb-2 text-center text-3xl font-bold text-gray-800">TaskFlow</h1>
        <p className="mb-8 text-center text-sm text-gray-500">Create an account</p>
        ...
        <div className="overflow-hidden rounded-2xl bg-white shadow-sm">
            ...
            <div className="px-8 py-8">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  />
                  {form.errors.email && (
                    <p className="text-xs text-red-500">{form.errors.email.message}</p>
                  )}
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  />
                  {form.errors.password && (
                    <p className="text-xs text-red-500">{form.errors.password.message}</p>
                  )}
                  {!form.errors.password && (
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  />
                  {form.errors.confirmPassword && (
                    <p className="text-xs text-red-500">{form.errors.confirmPassword.message}</p>
                  )}
                </div>
          ...
          <div className="border-t px-8 py-4 text-center text-sm text-gray-500">
            ...
            <Link to={paths.signIn} className="font-medium text-blue-500 hover:underline">
              Sign in
            </Link>
          </div>
        </div>
