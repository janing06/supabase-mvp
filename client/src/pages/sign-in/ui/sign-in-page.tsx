...
import type { useSignIn } from '../model/hooks/useSignIn'

type Props = {
  form: ReturnType<typeof useSignIn>
}

export const SignInPage = ({ form }: Props) => {
  return (
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="overflow-hidden rounded-2xl bg-white shadow-sm">
          ...
          <div className="border-t px-8 py-4 text-center text-sm text-gray-500">
            ...
            <Link to={paths.signUp} className="font-medium text-blue-500 hover:underline">
              Sign up
            </Link>
          </div>
        </div>
